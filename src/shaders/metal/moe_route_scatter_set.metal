...
// Scatter grouped MoE route outputs back to token order, writing the reduced
// top-k sum directly. This follows vLLM's topk_weight_and_reduce shape and
// avoids a separate zero-fill before scatter.
...
kernel void main0(
    ...
    dst[id] = invalid ? as_type<float>(0x7fc00000u) : sum;
}

...
// Exact K=2048 variant of dmmv_q8_0_repacked_quad.metal for Qwen3.6 SSM
// projections. This keeps the repacked row format and four adjacent output
// rows per simdgroup, but removes dynamic group-count and row-stride work from
// the hottest SSM Q8 path.
kernel void main0(
